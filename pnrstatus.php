...
{
$pnr=$_POST['pnr'];
$sql = "SELECT t_status FROM bookings WHERE PNR= '$pnr'";
...
{
$pnr=$_POST['pnr'];
$sql = "DELETE FROM bookings WHERE PNR=$pnr;";
...
<center>
	...
	<div id="pnrtext"><input type="text" name="pnr" size="30" maxlength="10" placeholder="Enter 10-digit PNR here"></div>
	<br/><br/>
	<input type="submit" name="submit" value="Check here!" class="button" id="submit"><br/><br/>
	<?php  
		if(isset($_SESSION['user_info'])){
			echo '<form action="pnrstatus.php" method="post"><input type="submit" class="button" value="Cancel booking" name="cancel" id="cancel"/></form>';
        }
		else
