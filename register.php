...
<HTML>
<HEAD>
<TITLE>Register 2A Journey</TITLE>
...
<P><INPUT TYPE="Submit" value="Submit" name="submit" id="submit" class="button" onclick="if(!this.form.tc.checked){alert('Please agree to our terms');return false}">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
